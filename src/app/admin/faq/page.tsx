...
import { FaQlist } from '@/lib/responses/faqLib';
...
import { FaqTable } from '@/components/pages/admin/table/FaqTable';
import {
  Select,
  SelectTrigger,
  SelectContent,
    ...
    <>
      <Container>
        <div className="flex items-center justify-between mb-4">
          ...
          />
          <PushButton href="/admin/faq/create_faq" label="Create FaQ" />
        </div>
