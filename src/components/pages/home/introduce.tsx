        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-6 text-gray-600">
              ...
              <span className="font-bold text-main">Unien</span> được biết đến
              là nhà cung cấp chuyên nghiệp với sản phẩm và dịch vụ chất lượng
              cao. Giải pháp kỹ thuật tối ưu cho khách hàng và đối tác trong
              lĩnh vực Lò Hơi Công Nghiệp.
            </p>
